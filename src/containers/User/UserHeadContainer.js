...
class UserHeadContainer extends Component {
  ...
  render() {
    ...
    return <UserHead username={username} thumbnail={thumbnail} thoughtCount={thoughtCount} />;
  }
}

export default connect(
  state => ({
    thumbnail: state.userPage.info.profile.thumbnail,
    thoughtCount: state.userPage.info.thoughtCount,
